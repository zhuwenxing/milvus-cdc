...
class TestCDCCreate(object):
    ...
    def test_cdc_for_collections_create_before_cdc_task(self, upstream_host, upstream_port, downstream_host,
                                                        downstream_port):
        """
        """
        connections.connect(host=upstream_host, port=upstream_port)
    ...
    @pytest.mark.skip(reason="https://github.com/zilliztech/milvus-cdc/issues/5")
